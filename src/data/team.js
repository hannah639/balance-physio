...
export const team = [
	{
		...
		bio: [
			"Lucy is Balance's Director of Spinal Care. She has over twenty five years experience in clinical spinal disorders and is a renowned back pain specialist.",
			...
			"Lucy is available for both online, virtual consultations and in-person assessment and treatment.",
		],
	},
	{
	...
	},
	{
		...
		bio: [
			"MSc, MCSP, SRP",
			"Graham Anderson Sports Physiotherapist with 30 years of experience and an abundance of treatment and rehabilitation wisdom. He works globally as a regular on the ATP Tennis Tour, locally at Balance Clapham SW4, and is Lead Physiotherapist for the Championships, AELTC Wimbledon SW11.",
	...
	},
	{
		...
		bio: [
			...
			"At Balance, Jonathan combines tailored exercises, hands-on therapy with innovative technology and a holistic approach, crafting personalised treatments for neck pain, dizziness, functional disorders, concussion, osteoporosis, whiplash, soft tissue injrand a wide range of neuromuscular and neurological conditions inclusing multiple sclerosis, stroke, and Parkinson's disease.",
	...
	},
	{
		...
		bio: [
			"Dan developed his passion for physiotherapy as a county-level decathlete. He completed a BSc in Sport & Exercise Science from the University of Hertfordshire, followed by a BSc in Physiotherapy from St Georges Medical School and an MSc in Sports Injury Rehabilitation from Salford University, studying under Olympic Games Physiotherapists.",
			"With over 15 years of clinical experience across the NHS, private practice, and elite sport, Dan specializes in Paediatric and youth physiotherapy and sports injury rehabilitation. He has supported runners at multiple London marathons and treated sprinters, endurance, and ultra-marathon athletes. For eight years, he has worked as a physiotherapist for the England Athletics team, assessing and treating young athletes aged Under 13 to Under 20.",
			"Previously an associate lecturer for the University of West England on their Sports Rehabilitation BSc, Dan has presented on overtraining and common adolescent athletic injuries to professional organizations. He emphasizes comprehensive assessments appropriate to growing children, identifying both acute and chronic injury causes while considering school, sleep, nutrition, and lifestyle factors.",
			"Dan believes rehabilitation should be engaging, creating child-centered plans to return young athletes to sport with enhanced performance and expanded movement capabilities. His goal is helping clients recover to surpass their pre-injury levels.",
			"Outside work, Dan is an avid runner and experienced scuba diver who has explored sites in Hawaii and Australia.",
		],
	},
	{
		slug: 'jonathan-lewis',
	...
	},
	{
		...
		bio: [
			"Jo completed her MSc in physiotherapy in 2009 at the University of Brighton to qualify as a physiotherapist and has worked to senior level in the NHS and in private practice over the past 8 years. She has experience with a wide range of conditions from postoperative, fracture and orthopedics, to sports injuries, acute and chronic back and neck pain. She has a particular interest in ACL rehabilitation and running injuries.",
			...
			"Jo is also a qualified APPI pilates instructor and uses pilates within her physiotherapy practice.",
			"Aside from her professional interests Jo enjoys the gym, swimming and recreational running, and has a background in basketball – despite her height!",
		],
	},
	{
		...
		bio: [
			"I am an experienced physiotherapist with a belief in supporting you to help yourself get better! This could include hands on therapy, tailored rehabilitation, acupuncture, return to sports programs and straight forward practical advice.",
			"I thrive on working with mixed level athletes from the very young to senior citizens involved in multiple sports and activities. Particularly those of you who are keen to engage in therapy, ready to improve and want to get back to being active. I believe it\\'s key to work within an expansive team including massage therapists, personal trainers, osteopaths, sports medicine doctors and Surgeons to ensure timely, effective and complete results. I have a thirst for learning and I am currently engaging in Masters level study.",
			"At the weekend you may catch me at the odd live music, comedy or spoken word nights. But you\\'re even more likely to catch me playing football for my now ageing Sunday league football team.",
		],
	},
	{
		...
		bio: [
			"Jarryd completed a Bachelor of Science degree in 2012 and then a four year BSc Physiotherapy degree in 2016 at the University of the Witwatersrand in Johannesburg, South Africa.",
			"He gained a plethora of experience in several fields of physiotherapy following completion of his BSc, before moving over to London at the start of 2018.",
			"Working in central London, in bedded rehabilitation units and community rehabilitation settings as well as a private musculoskeletal practice, Jarryd was able to build upon various musculoskeletal skills and expertise.",
			"Following this, he spent two and half years as a Senior First Contact Physiotherapist for GP Surgeries, providing frontline specialist musculoskeletal assessments, scan referrals and initial rehabilitation.",
			"A highlight in Jarryd\\'s career thus far was working as a physiotherapist for the 2022 Commonwealth Games in Birmingham, primarily with the Judo, Wrestling and Rugby 7s teams both at the athlete\\'s village and in training sessions.",
			"As a physio, Jarryd takes a friendly but firm approach to the rehabilitation of sports injuries, musculoskeletal pain, and post-surgery recovery in order to help you swiftly get back to doing the things you love.",
			"In his spare time, Jarryd enjoys swimming, art, theatre, spending time with friends, and taking advantage of all the quirks London has to offer.",
		],
	},
	{
	...
	},
	{
		...
		role: 'Physiotherapist',
		bio: [
			"Sam joined Balance in summer 2023 as a passionate physiotherapist with a strong sports background. An accomplished tennis player who captains his local club\\'s first team, he also spent a season as a Chalet Host in Meribel, France, developing his skiing skills.",
			"He has trained under Dr. Lucy Goldby, Consultant Spinal Physiotherapist, and collaborated with physiotherapists from GB Rowing and England Lacrosse. Sam earned his BSc in Sports Science and Mathematics from Nottingham Trent University, then pursued an MSc in Physiotherapy from St Mary\\'s Twickenham University, graduating in 2021.",
			"Before joining Balance, Sam advanced to Senior Musculoskeletal Physiotherapist within the NHS, gaining extensive experience across various healthcare settings. He is dedicated to promoting physical health and guiding patients through rehabilitation.",
		],
	},
	{
		slug: 'portia-morey',
	...
	},
	{
		...
		bio: [
			...
			"Steven is a member of the Royal College of Podiatry and the Royal College of Physicians and Surgeons of Glasgow. He is registered under the HCPC (CH 33142). He currently works at Balance Performance Physiotherapy on Mondays and Tuesdays. Please call to book at appointment (020 7627 2308) or book online: https://www.balancephysio.com/contact-balance/",
			"Areas of interest:",
			"Podiatric sports medicine Injuries to the foot, ankle and lower limb",
			"Expert gait analysis",
			"Exercise prescription and rehabilitation",
			"Elite level custom made orthotics",
			"Modified off the shelf orthotics Ankle Foot Orthoses (AFO) - Richie Brace",
	...
	},
	{
		...
		bio: [
			"Eli is our osteopath and nutritional therapist with a holistic approach to her treatments, using an mix of techniques and natural remedies wherever possible. She offers an integrated multi layered health care approach for the benefit of her clients whatever their health needs.",
			"She has sustained many injuries herself and her appreciation of the challenges motivate her to get her clients out of pain and enjoying their activities again as quickly and safely as possible.",

export const testimonials = [
    {
        ...
        quote: `Can't thank you enough for your help over the last week, Jo Sullivan. Appreciate you so much!`,
    },
    {
        name: 'JE',
        image: '/testimonials/je-menieres.jpg',
...
I booked with Balance Performance by chance and was referred to Jon Zulueta. I have now seen him five times so far and cannot speak more highly of his patience, expertise, reliability and professionalism. He is thorough, kind and knowledgeable and I would recommend without hesitation to anybody. I feel very fortunate to have found him!`,
    },
    {
        name: 'Claire Bennett',
...
I have been lucky enough to have had regular contact with much of the team at Balance, whether it be in strength and conditioning sessions with Jonathan, or physio with Paula, or sports massages with Louisa and Kellie. They have made a massive difference to me. What I like most about Balance is the fact that they never sit on their own success. They are passionate about what they do, utterly professional, and always one step head of the crowd. They are a team, and a fantastic one at that! I can count on them 100% and this gives me the confidence I need in the lead up to the 2012 Olympics. I believe in the value of association. You are only as good as the people you put around you, and so having the support of Balance Physio means everything to me. I cannot recommend them highly enough.`,
    },
    {
        name: 'Louise Ward',
...
He knew Graham "likes a challenge" and he was absolutely right. I have Graham and his team to thank for getting me back on my feet time and again.
...
After winning the Commonwealth Games in 2002 I had major surgery (A full Reconstruction on my Left knee) which put me out for eleven months of my Judo career. Balance took me under their wing and to help me in everyway possible to get back to full fitness. The team at Balance helped me with my rehabilitation, hence helping me with a speedy recovery to qualify for the 2004 Olympic Games, under the watchful eye of Graham Anderson and Jonathan Lewis. Since then I have been confident, positive and injury free.

In 2008-I sustained another major knee injury during a training camp in preparation up to the Olympic Games. I had keyhole surgery, which enabled me to get back in time to fight at the Beijing Games. After the games were over I went back under the knife again for a full reconstruction on my right knee. Thanks again to the Balance Team aiding my rehabilitation back to full fitness. Jason Progl helping me with my stretching, flexibility and core strength which helped enormously.

The team at Balance is a great asset and an excellent team to work with. I would recommend them to anyone who has sustained a sports Injury.

I thank them all for all their there help and support in enabling me to pursue my Olympic dream.`,
    },
    {
        name: 'Miriam Bremer',
...
Martina at the Clapham branch showed me the right exercises for Me including trigger point therapy in their brilliant studio area and advised me expertly on how I can work to heal myself.

Balance performance are interested in showing us how to move, strengthen and maintain ourselves in the exactly the right way to stay as fit as possible… I was so encouraged to see that they run regular classes and have extensive studio equipment to support this. Long gone are the days of lying on a couch plugged in to an ultra sound machine for half an hour! Hoorah!`,
    },
    {
        name: 'Al Riley',
...
I can't recommend Balance highly enough – every time I've had a running injury they've been able to diagnose the issue quickly, provide focussed rehab exercises and make me a stronger and more resilient runner as a result.`,
    },
    {
...
I now feel as strong as ever and can lift my kids high. Losing the excess weight made me feel good too.

Balance has educated me in how to stay fit and protect against injury. I consider myself extremely fortunate to have gained this skill. From no cycling at all before coming to Balance, I recently completed the Olympic Roadrace course.

Balance, as their motto says, has made me better, for me and my family. Whether treating elite athletes or not, their work is exceptional.

Thanks to all at Balance for their excellent work and support.`,
    },
    {
        name: 'Sheila W',
...
Best wishes and my heartfelt thanks for all the trouble you took to solve my problem.`,
    },
    {
        name: 'Simon Buckden',
...
Tweet from @100mara100weeks "@BalancePrfmance really pleased with the taping it helped a lot!"

By Challenging his body to the extreme and demonstrating that all it takes to succeed is exceptional mental strength and determination, Simon Buckden will run 100 Marathons in 100 consecutive weeks. What is more remarkable is that he has been running for over 20 years and until he started this challenge he had never ran a Marathon!

Simon is doing it all for charity and to raise awareness of PTSD, if you want to know more and make a donation go to:
http://www.bmycharity.com/100marathons

Simon saw Scott who was working with KT Tape Europe at the Amsterdam marathon. Simon was suffering from several problems that Scott then taped for Simon before the event using KT Tape.
...
Go to their great website to follow their progress and to sponsor them, their charity is Warchild, raising money for children affected by war.`,
    },
    {
        name: 'John Hunt',
